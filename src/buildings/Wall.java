...
public class Wall {
	...
	public Wall(double beginningX, double beginningY, double beginningZ,
	...
	public void draw(GL2 gl, GLU glu) {
        ...
        gl.glVertex3d(beginningX+xLength,beginningY,beginningZ-zLength);
        gl.glVertex3d(beginningX+xLength,beginningY+yLength,beginningZ-zLength);
        gl.glVertex3d(beginningX,beginningY+yLength,beginningZ);
        gl.glEnd();
        inside.bind(gl);
        gl.glBegin(GL2.GL_QUADS);
        gl.glVertex3d(beginningX,beginningY,beginningZ);
