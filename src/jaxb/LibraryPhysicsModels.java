...
public class LibraryPhysicsModels {
    ...
    protected List<PhysicsModel> physicsModels;
     ...
     * 						Gets the value of the physicsModels property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the physicsModels property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPhysicsModels().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PhysicsModel> getPhysicsModels() {
        if (physicsModels == null) {
            physicsModels = new ArrayList<PhysicsModel>();
        }
