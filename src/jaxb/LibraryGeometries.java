 ...
 *         &lt;element ref="{http://www.collada.org/2005/11/COLLADASchema}geometry" maxOccurs="unbounded"/>
...
public class LibraryGeometries {
     ...
     * This is why there is not a <CODE>set</CODE> method for the geometries property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGeometries().add(newItem);
     * </pre>
     * 
     * 
     * <p>
