...
public class ParkGhost implements Creature, PlayerMotionWatcher, ProjectileWatcher {
	...
	public ParkGhost(GL2 gl, GLU glu) {
	...
	public void drawStillMotion(GL2 gl, GLU glu) {
		T = T + 0.99f;
		checkT();
		hoverHeight();
	...
	public void moveIdle(GL2 gl, GLU glu) {
		if (!seesPlayer) {
